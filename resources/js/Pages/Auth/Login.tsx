    ...
    return (
        <GuestLayout>
            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
                ...
                <div className="mt-4 block">
                    <label className="flex items-center">
                        <Checkbox
                            ...
                            onChange={(event) => setData('remember', Boolean(event.target.checked))}
                        />
                ...
                <div className="pt-4">
                    <PrimaryButton
                        className="w-full justify-center rounded-full bg-gradient-to-r from-pink-500 to-purple-500 px-6 py-3 text-base font-semibold shadow-lg shadow-pink-200/60 transition hover:from-pink-400 hover:to-purple-400"
                        disabled={processing}
                    >
                        Log in
                    </PrimaryButton>
