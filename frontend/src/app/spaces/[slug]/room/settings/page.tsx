    ...
    <AuthenticatedLayout
      header={
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-warm-900">Room Settings</h1>
            <p className="text-warm-600">Configure your shared room</p>
          </div>
        </div>
      }
    >
      <div className="max-w-2xl mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Theme / Background */}
          <div className="rounded-3xl bg-white border-warm-100 shadow-xl shadow-warm-900/5 p-6">
            <label className="flex items-center gap-2 text-sm font-medium text-warm-700 mb-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  autoInvite ? 'bg-brand-500' : 'bg-warm-300'
                }`}
              >
                <span
          ...
          <div className="rounded-3xl bg-white border-warm-100 shadow-xl shadow-warm-900/5 p-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  notifications ? 'bg-brand-500' : 'bg-warm-300'
                }`}
              >
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
