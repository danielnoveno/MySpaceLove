    ...
    <AuthenticatedLayout
      header={
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-warm-900">Create Surprise Drop</h1>
            <p className="text-warm-600 text-sm">Send a surprise music track</p>
          </div>
        </div>
      }
    >
      <div className="max-w-2xl mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Schedule */}
          <div className="rounded-3xl bg-white border border-warm-100 shadow-xl shadow-warm-900/5 p-6">
            <label htmlFor="scheduledAt" className="block text-sm font-medium text-warm-700 mb-2">
              <span className="flex items-center gap-2">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-warm-200 px-4 py-3 text-warm-900 placeholder-warm-400 focus:border-brand-400 focus:ring-2 focus:ring-brand-100 outline-none transition-all"
            />
            <p className="mt-2 text-xs text-warm-500">Leave empty to send immediately</p>
          </div>
