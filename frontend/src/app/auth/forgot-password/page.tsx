      ...
      <div className="min-h-screen flex items-center justify-center bg-brand-50 p-4">
        <FadeIn>
          <div className="w-full max-w-md text-center">
            ...
            <h1 className="text-2xl font-bold text-warm-900 mb-2">Periksa email Anda</h1>
      ...
      <FadeIn>
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-warm-900">Reset password Anda</h1>
            <p className="text-warm-500 mt-2">Masukkan email dan kami akan mengirimkan tautan reset</p>
          </div>

          <form onSubmit={handleSubmit} className="bg-white rounded-3xl border border-warm-100 p-8 shadow-xl shadow-warm-900/5 space-y-6">
            {error && (
              <div id="forgot-error" role="alert" className="rounded-xl bg-coral-50 border border-coral-200 p-4 text-sm text-coral-600">{error}</div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-full bg-brand-500 py-3 text-sm font-semibold text-white hover:bg-brand-600 transition-all hover:shadow-lg hover:shadow-brand-500/25 focus:ring-2 focus:ring-brand-200 disabled:opacity-50 flex items-center justify-center gap-2 active:scale-[0.98]"
            >
