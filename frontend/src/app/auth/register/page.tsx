  ...
  return (
    <GuestLayout
      hero={{
        ...
        subtitle: 'Create a space where love grows stronger every day.',
        features: [
          'Build a private world just for you and your partner.',
          'Share memories, milestones, and daily moments.',
      ...
      <div className="space-y-6">
        <div className="space-y-2 text-center">
          ...
          <p className="text-sm text-gray-600">
            Join MySpaceLove and start building your shared space.
          </p>
        </div>

        {error && (
          <div id="register-error" role="alert" className="rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
            {error}
          </div>
        )}
