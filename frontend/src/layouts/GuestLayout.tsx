...
export default function GuestLayout({ children, hero }: GuestLayoutProps) {
  const heroContent = {
    ...
    title: hero?.title ?? 'MySpaceLove helps you nurture a beautiful shared space.',
    subtitle: hero?.subtitle ?? 'Craft rituals, share memories, and surprise each other from anywhere.',
