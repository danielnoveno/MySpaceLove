    ...
    private function buildHtml(): string
    {
        ...
        <body style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background: linear-gradient(135deg, #ec4899, #f43f5e); border-radius: 16px; padding: 32px; text-align: center; color: white;">
                <h1 style="margin: 0; font-size: 24px;">🎉 Permintaan Diterima!</h1>
            </div>
            <div style="padding: 32px; background: #f0fdf4; border-radius: 0 0 16px 16px;">
                <p>Halo <strong>{$this->requester->name}</strong>,</p>
                <p>Selamat! Permintaan bergabung ke Space <strong>"{$spaceTitle}"</strong> telah diterima oleh <strong>{$ownerName}</strong>.</p>
                <p>Sekarang kamu sudah resmi terhubung di Space ini. Mulai berbagi momen bersama!</p>
